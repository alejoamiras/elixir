...
export const MINER_ARTIFACT_PATH = resolve(repo, 'protocol/contracts/target/yacana_miner-YacanaMiner.json');
export const WORK_ARTIFACT_PATH = resolve(repo, 'protocol/work-circuit/target/yacana_work.json');
