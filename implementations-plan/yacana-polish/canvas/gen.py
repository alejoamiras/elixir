...
ROWS: list[list[tuple]] = [
    ...
    [  # the account dialog
        ...
        ("WordsLogInError", A.words_login(error="list"), 492, 540, "Account · words · not in the list"),
        ("WordsLogInChecksum", A.words_login(error="checksum"), 492, 560, "Account · words · one is off"),
    ...
    [  # mine
        ...
        ("PrestoReasons", M.presto_reasons(), 760, 1300, "Presto · every reason"),
    ],
    [  # wallet
        ...
        ("WalletPhone", W.wallet_phone(), 390, 1000, "Wallet · phone"),
    ...
    [  # navigation, copy, phone
        ...
        ("CopyDeck", X.copy_deck(), 1200, 3620, "The copy deck"),
...
def main():
    ...
    canvas = {
        ...
        "annotations": [{"id": "brief", "x": 0, "y": -130, "w": 620,
                         "text": "Yacana polish — the design pass, v3. Rows: the rules, the picks, the IA, every crossing state · the account dialog and its failures · Mine · Wallet and the activity rows · the transaction dialog (send, bridge to, claim, bridge from) · the upgrade and v5 · Settings · navigation, the copy deck, the phone. Every board is what the app would show; A/B/C boards are picks (the recommended one is outlined)."}],
        "launch": {"view": "canvas"},
    }
