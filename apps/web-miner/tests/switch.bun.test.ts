...
import type { SwitchableNode } from '@yacana/web-kit/browser/node';
...
let guard: typeof import('@yacana/web-kit/browser/node-guard');
...
describe('the live node switch', () => {
  ...
  beforeAll(async () => {
    ...
    guard = await import('@yacana/web-kit/browser/node-guard');
